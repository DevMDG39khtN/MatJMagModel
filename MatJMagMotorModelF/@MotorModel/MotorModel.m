classdef MotorModel < handle
    ...
    methods(Access = public)
        [sTrqMap, sFluxMap, sMapLdq, sMapLdqS]  = MappingController(o, skId,stt)
        [sTrqMap, sFluxMap] = MappingModel(o, skId, stt)
        ...
        [sTrqToIdq,sMapIdqToFdq] = MappingTrqToIdq(o, skId, stt)
        mTrqToIdIq = MakeReqMapTtoIdq(o, vTrqs, vNrpms, vVlts, rLmtV, dltTrq, dltIdq)

        tMap = MappingIdqToTrq(o, dltIdq, skId, stt)    % Torque Map
        tMap = MappingIdqToFdq(o, dIdq, skId, stt)
        stFIMap = MappingFdqToIdq(o, dIdq, dFdq, skId, stt)
        [sMapLdq, sMapLdqS] = MappingIdqToLdq(o, dIdq, skId, stt)
